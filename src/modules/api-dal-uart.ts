...
class ApiDalUart extends ApiDalBase {
    ...
    private writeBytesToPort(bytes: Array<number>): boolean {
        ...
        /*let isWaitingForDrain: boolean = this._serialPort.write(bytes, 'utf8', ((error: Error, bytesWritten) => {
            // TODO: do something with this - log?
        }));
        */
        let isWaitingForDrain: boolean = this._serialPort.write(bytes, 'utf8')
